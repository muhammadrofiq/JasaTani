...
public class Secondfragment_1 extends Fragment {
    private static final String TAG = "Secondfragment_1";
    ...
    public static List<Openorder_model> listorder_frstfrag2;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.secondfragment_1,container,false);
        ...
        Query query = FirebaseDatabase.getInstance().getReference("neworder/"+user.getUid())
                .orderByChild("unixdate")
                .limitToLast(15);
        query.addValueEventListener(valueEventListener);


        recyclerViewallitem = view.findViewById(R.id.list_neworder);
        text = view.findViewById(R.id.text_secfrag1);
        recyclerViewallitem.setHasFixedSize(true);
        recyclerViewallitem.setLayoutManager(new LinearLayoutManager(activity));

        listorder_frstfrag2 = new ArrayList<>();
        adapter = new Adapter_ongoingorder(listorder_frstfrag2, activity);
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            if(dataSnapshot.exists()){
                for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    listorder_frstfrag2.add(ordermodel);
